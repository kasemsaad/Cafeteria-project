                ...
                <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="post" action="CustomerControler.php">
                                ...
                                <div class="col-md-6 mb-4 pb-2">
                                    <div class="form-outline">
                                        <input type="password" id="Confirm Password"
                                            class="form-control form-control-lg" name="ConPassword" />
                            ...
                            <?php
                            if (isset($err['err'])) {
                                echo "<span style='color:red'>$err[err]</span> <br>";
                            }
                            ?>

                            <div class="mt-4 pt-2">
                                <input class="btn btn-primary btn-lg center" type="submit" value="Reset"
                                    name="resetPassword" />
                            </div>
